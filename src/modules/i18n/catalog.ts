...
export const translations: Record<Locale, Translation> = {
  "en-US": {
    ...
    about: {
      ...
      stackIntro:
        "Tools I use to design, ship, test, and operate production systems.",
      stack: [
        {
          label: "Backend",
          items: [
        ...
        },
        {
          ...
          items: ["Docker", "CI/CD", "AWS", "Azure", "Git"],
        },
        {
          label: "Quality",
          items: [
  ...
  "pt-BR": {
    ...
    about: {
      ...
      stackLabel: "Amplitude técnica",
      stackIntro:
        "Ferramentas que uso para projetar, entregar, testar e operar sistemas em produção.",
      stack: [
        {
          label: "Backend",
          items: [
  ...
  "es-AR": {
    ...
    about: {
      ...
      stackLabel: "Alcance técnico",
      stackIntro:
        "Herramientas que uso para diseñar, entregar, testear y operar sistemas en producción.",
      stack: [
        {
          label: "Backend",
          items: [
